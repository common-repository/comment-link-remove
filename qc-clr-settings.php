        ...
        <p> <?php  esc_html_e( 'Here you can manage custom settings for the Comment Link Remove plugin.', 'qc-clr' ); ?></p>
         <?php 
                        ...
                        if( current_user_can( 'manage_options' ) )
                        {
                            if( isset($_POST['delAllCmts']) && $_POST['delAllCmts'] == 'delAllCmts' ){
                                ...
                                if ( !isset($_POST['qc_clr_nonce']) || !wp_verify_nonce($_POST['qc_clr_nonce'],'qc-clr') ) {
                                    ...
                                    echo "<strong>".esc_html( 'You didn\'t send any credentials.', 'qc-clr' )."</strong><br>";
                                    ...
                                    if($response){
                                        ...
                                        echo "<strong>".esc_html( 'All Comments deleted successfully!', 'qc-clr' )."</strong><br>"; 
                                    }
                            ...
                            if( isset($_POST['delPendingCmts']) && $_POST['delPendingCmts'] == 'delPendingCmts'  ){
                                ...
                                if ( !isset($_POST['qc_clr_nonce']) || !wp_verify_nonce($_POST['qc_clr_nonce'],'qc-clr') ) {
                                    ...
                                    if($response){
                                        ...
                                        echo "<strong>".esc_html( 'All Pending Comments deleted successfully!', 'qc-clr' )."</strong><br>"; 
                            ...
                            if( isset($_POST['delSpamCmts']) && $_POST['delSpamCmts'] == 'delSpamCmts'  ){
                                ...
                                if ( !isset($_POST['qc_clr_nonce']) || !wp_verify_nonce($_POST['qc_clr_nonce'],'qc-clr') ) {
                                    ...
                                    if($response){
                                        ...
                                        echo "<strong>".esc_html( 'All Spam Comments deleted successfully!', 'qc-clr' )."</strong><br>"; 
            ...
            <div class="clr_warapper clr_warapper_box">
                <h4><?php  esc_html_e( 'Try our FREE ChatBot for WordPress with AI - WPBot.', 'qc-clr' ); ?></h4>
                <p><?php esc_html_e( 'It is an easy to use, Native, No coding required, AI ChatBot to provide Automated Live Chat Support. Use ChatBot to', 'qc-clr' ); ?> <strong> <?php esc_html_e( 'answer user questions', 'qc-clr' ); ?></strong> <?php esc_html_e( 'and also', 'qc-clr' ); ?> <strong><?php esc_html_e( 'collect information', 'qc-clr' ); ?></strong> <?php esc_html_e( 'from the users using', 'qc-clr' ); ?> <strong><?php esc_html_e( 'conversational forms', 'qc-clr' ); ?></strong>. <?php esc_html_e( 'It can be also be powered by DialogFlow, Tavily or OpenAI ChatGPT or simply use the built-in features to provide Live support and collect data.', 'qc-clr' ); ?></p>
                <?php include_once QCCLR_PLUGIN_DIR_PATH . '/qc-clr-recommendbot-plugin.php'; ?>
                <p class="qcld_live_link_wrap"><a class="qcld_live_link" href="<?php echo esc_url('https://www.wpbot.pro/'); ?>" target="_blank" ><?php esc_html_e( 'Check the Live Demo', 'qc-clr' ); ?></a></p>
            </div>
            <div class="clr_warapper">
